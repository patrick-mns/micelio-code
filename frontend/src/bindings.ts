...
export const commands = {
  ...
  saveLitellmKey: (args: { key: string }) => invoke<void>('save_litellm_key', args),
  checkLitellmKey: (args: { key: string }) => invoke<any>('check_litellm_key', args),
  getLitellmBaseUrl: () => invoke<string>('get_litellm_base_url'),
  saveLitellmBaseUrl: (args: { url: string }) => invoke<void>('save_litellm_base_url', args),
